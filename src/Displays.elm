...
import Types exposing(Player, Msg(..), Game, Color(..), CardState(..), StackShadow(..), Card, Position(..), Reverse(..) )
import Html exposing (Html, div, h1, h2, h4, hr, text, a, button, br, b, span)
import List exposing (head, sortBy, map, length, range, take, indexedMap)
